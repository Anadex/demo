...
import com.example.feedback_quiz.quiz.QuizStorage.quizRu
...
class QuestionsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        for (n in quizRu.questions.indices) {
            ...
            val question = quizRu.questions[n]
        ...
        binding.send.setOnClickListener {
            ...
            for (i in radioGroupIDList.indices) {
                ...
                quizRu.questions[i].answers.forEachIndexed { index, ans ->
                    if (ans == answer) numsOfAnswers.add(index)
                }

            }

            val resultList = QuizStorage.answer(quizRu, numsOfAnswers)
