...
import com.example.feedback_quiz.databinding.FragmentStartBinding
    ...
    override fun onCreateView(
        ...
        binding.ageBtn.setOnClickListener {
            ...
            datePicker.addOnPositiveButtonClickListener { timeInMillis ->
                ...
                Snackbar.make(requireActivity().findViewById(R.id.fragmentContainerView), dateFormat.format(calendar.time), Snackbar.LENGTH_LONG).show()
            }
